...
local Window = Library.CreateLib("Cum Gusher GUI", "LightTheme")
    -- MAIN
    local Main = Window:NewTab("PAGE 1")
    local MainSection = Main:NewSection("PAGE 1")


    MainSection:NewToggle("TP Spammer", "Spams Toilet Paper", function()
    ...
    MainSection:NewToggle("Universal Aimbot", "Locks On to Players", function(state)
...
loop = RunService.RenderStepped:Connect(function()
   ...
   if UserInputService:IsKeyDown(Enum.KeyCode.Delete) then
    ...
    MainSection:NewButton("Chat Bypass", "Allows You To Say Some Naughty Stuff", function()
        --Homo Erectus#7638 was here
--
local Bypasses = {
    ["ass"] = "as{{aieixzvzx:s}}",
...
Notify("Loaded Successfully", "Chat Bypass Loaded!", 15)
print(string.format("Anti Chat-Logger has loaded in %s seconds.", tostring(tick() - ACL_LoadTime):sub(1, 4)))
    ...
    MainSection:NewButton("Play Every Sound", "Plays Every Sound Possible", function()
...
MainSection:NewToggle("Mouse Fling [E]", "Fling Players With Your Mouse", function(state)
    ...
    --LOCAL PLAYER
    local Player = Window:NewTab("PAGE 2")
    ...
    --Other
    local Other = Window:NewTab("PAGE 3")
    local OtherSection = Other:NewSection("PAGE 3")

    OtherSection:NewButton("Chat Spoofer", "Lets you chat for other people", function()
        loadstring(game:HttpGet(('https://pastebin.com/raw/djBfk8Li'),true))()
    end)

    OtherSection:NewButton("Weird Ass Fly", "Fly", function()
